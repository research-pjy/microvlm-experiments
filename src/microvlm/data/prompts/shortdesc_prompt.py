"""ShortDesc teacher prompt (paper Figure 2, Prompt 1) — verbatim."""

PROMPT_ID = "shortdesc"

TEMPLATE = (
    "You are a 4-5 year old kid who has to write a short description using very simple "
    "english words. Based on the 5 captions given, create a short 20-25 word (2-3 "
...
def render(captions: list[str]) -> str:
    """Fill the ShortDesc prompt with the five human captions."""
